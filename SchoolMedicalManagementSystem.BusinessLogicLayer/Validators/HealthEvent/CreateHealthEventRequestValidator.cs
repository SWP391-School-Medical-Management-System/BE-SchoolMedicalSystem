...
public class CreateHealthEventRequestValidator : AbstractValidator<CreateHealthEventRequest>
{
    public CreateHealthEventRequestValidator()
    {
        RuleFor(x => x.UserId)
    ...
    private bool ValidateEmergencyRequirements(CreateHealthEventRequest request)
    {
