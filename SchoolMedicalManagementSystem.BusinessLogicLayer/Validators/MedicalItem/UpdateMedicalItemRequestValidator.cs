...
public class UpdateMedicalItemRequestValidator : AbstractValidator<UpdateMedicalItemRequest>
{
    public UpdateMedicalItemRequestValidator()
    {
        RuleFor(x => x.Type)
    ...
    private bool HaveValidExpiryDateForMedication(UpdateMedicalItemRequest model)
    {
