...
public class ManagerUpdateUserRequestValidator : AbstractValidator<ManagerUpdateUserRequest>
{
    public ManagerUpdateUserRequestValidator()
    {
        ...
        RuleFor(x => x.Role)
            ...
            .WithMessage("Manager chỉ có thể cập nhật tài khoản Student hoặc Parent");
